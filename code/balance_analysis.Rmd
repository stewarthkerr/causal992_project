...
balance_cols = colnames(after)[8:ncol(after)]
...
treatvar.before = apply(treatedmat.X.before, 2, var, na.rm=TRUE);
controlvar.before = apply(controlmat.X.before, 2, var, na.rm=TRUE);
...
stand.diff.after = (treatedmean.after-controlmean.after)/sqrt((treatvar.after+controlvar.after)/2);
